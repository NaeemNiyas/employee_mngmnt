package com.williamslea.employeemanagement.controller;
...
import com.williamslea.employeemanagement.serviceIMPL.EmployeeServiceImpl;
...
public ResponseEntity<String> removeEmployee(@PathVariable int id)
{
    ...
    return new ResponseEntity<String>("Remove Sucessfull",HttpStatus.ACCEPTED);
}
